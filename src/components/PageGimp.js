...
class PageGimp extends Component {
	constructor() {
		super();
		this.state = {
			flashcards: []
	...
	render() {
		const filteredFlashcards = this.state.flashcards.filter(item => item.category === 'gimp');
